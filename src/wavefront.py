...
class AbstractModel(object):
    ...
    def DrawQuick(self):
        ...
        glRotatef(self.rotation.angle, self.rotation.x,
        ...
        for line in fileHandle:
            ...
            if len(words):
                ...
                if command == 'newmtl':
                    ...
                    material.texture = catalogueTextures.chargerTexture(
                        material.mapKd)
